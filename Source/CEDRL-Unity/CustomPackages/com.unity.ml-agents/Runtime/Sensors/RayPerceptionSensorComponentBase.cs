...
namespace Unity.MLAgents.Sensors
{
    ...
    public abstract class RayPerceptionSensorComponentBase : SensorComponent
    {
        ...
        [HideInInspector, SerializeField, FormerlySerializedAs("AgentGameObject")]
        ...
        public GameObject AgentGameObject
        {
            ...
            set { m_AgentGameObject = value; UpdateSensor(); }
        }
        ...
        public RayPerceptionInput GetRayPerceptionInput()
        {
            ...
            rayPerceptionInput.ExcludeAgent = AgentGameObject;
