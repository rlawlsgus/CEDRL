...
public class CEDRL_PersonalZoneEvaluator : MonoBehaviour
{
    public static CEDRL_PersonalZoneEvaluator Instance;
    ...
    {
        CEDRL_Agent[] allAgents;
        
        if (agentsRoot != null)
        {
            allAgents = agentsRoot.GetComponentsInChildren<CEDRL_Agent>();
        }
        else
        {
            allAgents = FindObjectsOfType<CEDRL_Agent>();
        }
    ...
    private bool IsSameGroup(CEDRL_Agent a, CEDRL_Agent b)
    {
